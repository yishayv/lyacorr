...
class Settings():
    ...
    def write_default_settings(self):
        value_plate_dir_list = ['/mnt/gastro/sdss/spectro/redux/v5_7_0',
                                '/mnt/gastro/sdss/spectro/redux/v5_7_2']
        value_pca_continuum_tables = ['../../data/Suzuki/datafile4.txt',
    ...
    def get_plate_dir_list(self):
        return self.config_parser.get(self.section_file_paths, self.opt_plate_dir_list)

    def get_pca_continuum_tables(self):
        return self.config_parser.get(self.section_file_paths, self.opt_pca_continuum_tables)
