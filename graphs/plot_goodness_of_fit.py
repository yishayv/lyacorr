...
from continuum_goodness_of_fit import calc_fit_powerlaw, fit_function
...
power_law_coefficients = {i.name: i.value for i in result.params.values()}

print('return (((np.log(snr) + ({d})) ** {a}) * {b}) + {c}'.format(**power_law_coefficients))
