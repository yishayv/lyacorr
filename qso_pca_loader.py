...
class PCALoaderParis:
    ...
    LY_A_PEAK_INDEX = int((LY_A_PEAK_BINNED - BLUE_START) / WAVELENGTH_STEP)
    LY_A_NORMALIZATION_BIN = 1280
    LY_A_NORMALIZATION_INDEX = int((LY_A_NORMALIZATION_BIN - BLUE_START) / WAVELENGTH_STEP)
    NUM_RED_BINS = int((RED_END - LY_A_PEAK_BINNED) / WAVELENGTH_STEP + 1)
    NUM_FULL_BINS = int((RED_END - BLUE_START) / WAVELENGTH_STEP + 1)
    RED_END_GOODNESS_OF_FIT_INDEX = int(RED_END_GOODNESS_OF_FIT / WAVELENGTH_STEP)
    PC1_INDEX = 2
